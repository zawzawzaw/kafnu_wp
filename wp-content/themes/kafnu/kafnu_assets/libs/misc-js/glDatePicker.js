 ...
 */
 ;(function() {
	...
	$.fn.glDatePicker.defaults =
	{
		...
		onSelectChange: function(el, yearSelect, monthSelect) {},
	...
	var glDatePicker = (function() {
		...
		glDatePicker.prototype =
		{
			...
			render: function(renderCalback) {
				...
				var selectableYears = getSelectableList(todayVal.year - 100, todayVal.year + 10, options.selectableYears);
				...
				var onYearMonthSelect = function() {
					...
					options.onSelectChange(el, yearSelect, monthSelect);
				};
