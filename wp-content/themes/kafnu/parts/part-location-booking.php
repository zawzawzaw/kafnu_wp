    ...
    <div id="page-default-booking-item-desktop" class="hidden-sm hidden-xs">
      <div class="row">
        ...
        <div class="col-md-3 no-padding page-default-booking-item <?php if(strpos($post_title, 'tp') !== false) echo 'tp-version'; else echo $post_title; ?>">
            ...
            <div class="page-default-booking-item-text <?php if(strpos($post_title, 'tp') !== false) echo 'tp-location'; ?>">
              <h5><?php echo $booking_item_title; ?></h5>
              <p><?php echo $booking_item_copy; ?></p>
              <span id="price-changes" class="price <?php if(strpos($post_title, 'tp') !== false) echo 'tp-loc-price'; ?>"><?php echo isset($booking_item_URLs[0]['_kafnu_booking_item_price']) ? $booking_item_URLs[0]['_kafnu_booking_item_price'] : ""; ?></span>
            </div>
