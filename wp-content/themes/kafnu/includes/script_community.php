  ...
  <?php if ($is_debug == true): ?>
    ...
    <script type="text/javascript">
      goog.require('kafnu.page.Community');
    </script>
  ...
  <?php else: ?>
    ...
    <script type="text/javascript">
      ...
      var PAGE_LIBRARY        = "kafnu_assets/js/minified/libraries-community.min.js";
      var PAGE_JS             = "kafnu_assets/js/minified/page-community.min.js";
      ...
      window.head_js.load(PAGE_LIBRARY, function() {
        window.head_js.load(PAGE_JS, function() {
          window.page = new kafnu.page.Community({});
        });
      });
    </script>
