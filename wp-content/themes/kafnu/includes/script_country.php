  ...
  <?php if ($is_debug == true): ?>
    ...
    <!-- INSERT CSS HERE -->
    <link rel="stylesheet" type="text/css" href="kafnu_assets/css/style.css?v=2">
    ...
    <script type="text/javascript" src="kafnu_assets/libs/isotope/isotope.pkgd.min.js"></script>

    <!-- odometer animation -->
    <script type="text/javascript" src="kafnu_assets/libs/odometer/odometer.min.js"></script>
    ...
    <script type="text/javascript">
      goog.require('kafnu.page.Country');
    </script>
  ...
  <?php else: ?>
    ...
    <script type="text/javascript">
      ...
      var PAGE_LIBRARY        = "kafnu_assets/js/minified/libraries-country.min.js";
      var PAGE_JS             = "kafnu_assets/js/minified/page-country.min.js";
      ...
      window.head_js.load(PAGE_LIBRARY, function() {
        window.head_js.load(PAGE_JS, function() {
          window.page = new kafnu.page.Country({});
        });
      });
    </script>
