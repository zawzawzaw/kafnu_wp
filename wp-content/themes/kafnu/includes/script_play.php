  ...
  <?php else: ?>
    ...
    <script type="text/javascript">
      ...
      var PAGE_LIBRARY        = "kafnu_assets/js/minified/libraries-play.min.js";
      var PAGE_JS             = "kafnu_assets/js/minified/page-play.min.js";
      ...
      window.head_js.load(PAGE_LIBRARY, function() {
        window.head_js.load(PAGE_JS, function() {
          window.page = new kafnu.page.Play({});
        });
      });
    </script>
