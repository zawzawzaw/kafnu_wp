<?php 
  /*
   * Template Name: Page Press Landing Page
   */
?>
<?php get_header(); ?>      
      ...
      <div id="page-press-fact-sheets">
        <div class="row">
          ...
          <div class="col-md-8 no-padding">
            <div class="manic-image-container">
              <img src="" data-image-desktop="<?php echo THEMEROOT; ?>/images_cms/press/property-fact-sheets.jpg"
               data-image-tablet="<?php echo THEMEROOT; ?>/images_cms/press/property-fact-sheets.jpg"
               data-image-mobile="<?php echo THEMEROOT; ?>/images_cms/press/property-fact-sheets.jpg" alt="">
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <div class="cta-container">
                ...
                <span>All photography is owned or licensed by Kafnu Group Pte Ltd. Misrepresentation of these photographs <br class="hidden-xs hidden-sm "> is prohibited. For usage information, please contact <a href="mailto:press@kafnu.com">press@kafnu.com</a>.</span>
              </div>      
            </div> <!-- end col-md-6 -->
          </div>
